...
const routes: Routes = [{
  path: 'rota-filha', component: RotaFilhaComponent, children: [
    { path: '', redirectTo: 'component-one', pathMatch: 'full' },
    { path: 'component-one', component: ComponentOneComponent },
    { path: 'component-two/:id', component: ComponentTwoComponent, children: [
      { path: '', redirectTo: 'child-one', pathMatch: 'full' },
      { path: 'child-one', component: ChildOneComponent },
      { path: 'child-two', component: ChildTwoComponent, children: [
        { path: '', redirectTo: 'child-two-nested', pathMatch: 'full' },
        { path: 'child-one', component: ChildOneComponent },
